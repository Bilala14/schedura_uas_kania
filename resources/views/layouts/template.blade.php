...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('/assets/vendors/css/vendor.bundle.base.')}}">
    <!-- endinject -->
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name text-center">
                    <h5 class="mb-0 font-weight-normal" style="color: #000 !important;">{{ Auth::user()->name }}</h5>

                    <!-- Tombol Logout di bawah nama -->
